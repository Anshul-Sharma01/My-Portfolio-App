    ...
    return(
        <>
            ...
            <section className="flex justify-center items-center hddn_class h-100vh">
                <div className="hero_first_section w-3/6 p-8 flex gap-8 ml-48 justify-center items-center">
                    ...
                    <div className='flex flex-col gap-4 justify-center items-center text-justify'>
                        <h1 className="text-6xl font-sans font-bold hddn_class ">
                        ...
                        <div className="container flex flex-col">
                            <p className="text-2xl">
                                ...
                                <h1 className="text-2xl ">
                                    I am a passionate&nbsp;  
                                    <span ref={el}></span><br />
                                    with a love for turning ideas into reality through code...
                                </h1>
                            </p>
                        </div>
                    </div>
                </div>
                <div className="hero_second_section w-3/6">
