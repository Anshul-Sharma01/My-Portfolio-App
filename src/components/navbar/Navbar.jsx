        ...
        <>
            <div className="fixed hidden md:flex justify-around p-5 mb-2 w-full items-center  top-0 z-10 bg-black bg-opacity-50 backdrop-blur-md ">
                ...
                <ul className="sm:flex justify-between gap-10 list-none">
                    <li className="hover:border-b-4 hover:border-b-blue-400 duration-75 hover:text-lg"><a href="#hero">Home</a></li>
                    ...
                    <li className="hover:border-b-4 hover:border-b-blue-400 duration-75 hover:text-lg"><a href="#about">About</a></li>
                    <li className="hover:border-b-4 hover:border-b-blue-400 duration-75 hover:text-lg"><a href="#contact">Contact Me</a></li>
                </ul>
