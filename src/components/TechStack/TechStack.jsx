...
function TechStack(){
    return(
        <div className="hddn_class m-20">
            <h1 className="text-2xl font-bold font-sans p-4 ml-5 text-left pb-6">What I Know </h1>
            <div className="flex flex-wrap gap-20 ml-10 text-2xl">
                <div className="w-[250px] rounded-md border p-3 bg-[#1c1b23]">
                    <div className="p-2">
                ...
                <div className="w-[250px] p-3 rounded-md border bg-[#1c1b23]">
                    <div className="p-2">
